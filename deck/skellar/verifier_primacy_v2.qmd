...
```
CLAIMS DEPARTMENT                          NEW: AI Claims Assistant
───────────────────────────────────────    ────────────────────────────────────
Staff: 12 adjusters                        - Reads claim documents
Volume: 500+ claims/day                    - Pulls policy from admin system
Target: 45 claims/adjuster/day             - Checks coverage rules
Avg time per claim: 10-12 minutes          - Calculates recommended payout
                                           - Presents recommendation to adjuster
```

::: {.fragment style="background-color: #1E3A5F; padding: 20px; border-radius: 8px; margin-top: 30px;"}
**AI DOES NOT have authority to approve. AI DOES NOT have access to payment system.**

Human adjuster must click [APPROVE] or [REJECT].
