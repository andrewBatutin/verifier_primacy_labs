...
::: {.notes}
Sierra — компанія за $10B — зробила свій бенчмарк τ-bench.
Найкращі моделі проходять 85% тестів. На чистих, синтетичних даних.
В реальності — набагато гірше.

Висновок: розрив між "вражаючим демо" і "контрактно надійним" — величезний.
І його не закрити кращою моделлю. Тільки верифікацією.
:::
...
::: {.notes}
Sierra — $10B компанія — закриває gap між демо і продакшеном дорогими інженерами.
3-5 тижнів на клієнта. Не масштабується.

Але нові моделі з RL набагато краще слідують правилам.
Тепер можна інвертувати: закодувати бізнес-правила як формальні обмеження,
верифікаційний шар ловить помилки, модель виправляє себе.
Верифікація стає продуктом, а не фічею безпеки.
:::
...
::: {.notes}
Довіра — це не відчуття. Це формальна, доказова властивість.
Її можна виразити як SLA.

Агент генерує. Верифікатор доводить. Бізнес бачить pass/fail rate, який можна вписати в контракт.
Outcome-based pricing стає бізнес-моделлю, а не ризиком.

І голос — наступний фронтір. Голосові взаємодії — вищі ставки, вища цінність, складніше верифікувати вручну.
Формальний верифікаційний шар для голосу — це справжній moat.
:::
...
::: {.fragment .fade-up style="margin-top: 30px; font-size: 1.1em; color: #0891B2;"}
